...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3980082035ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bookstore_db&table=orders">`bookstore_db`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bookstore_db&table=feedback">`bookstore_db`.`feedback`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bookstore_db&table=products">`bookstore_db`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bookstore_db&table=user">`bookstore_db`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bookstore_db&table=cart">`bookstore_db`.`cart`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=library&table=member">`library`.`member`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=library&table=transaction">`library`.`transaction`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=library&table=book">`library`.`book`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5e447e26413b3e6270303f42302b4d49">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="bookstore_db" targettable="cart">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `bookstore_db`.`cart` ( `id` INT(100) NOT NULL AUTO_INCREMENT ,  `user_id` INT(100) NOT NULL ,  `name` VARCHAR(100) NOT NULL ,  `price` VARCHAR(100) NOT NULL ,  `quantity` INT(100) NOT NULL ,  `image` VARCHAR(100) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bookstore_db" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="bookstore_db" targettable="products">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `bookstore_db`.`products` ( `id` INT(100) NOT NULL AUTO_INCREMENT ,  `name` VARCHAR(100) NOT NULL ,  `price` INT(100) NOT NULL ,  `category` VARCHAR(100) NOT NULL ,  `image` VARCHAR(100) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="bookstore_db" targettable="orders">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `bookstore_db`.`orders` ( `id` INT(100) NOT NULL AUTO_INCREMENT ,  `user_id` INT(100) NOT NULL ,  `name` VARCHAR(100) NOT NULL ,  `phone` VARCHAR(12) NOT NULL ,  `email` VARCHAR(100) NOT NULL ,  `pay_method` VARCHAR(50) NOT NULL ,  `address` VARCHAR(500) NOT NULL ,  `total_pdts` INT(100) NOT NULL ,  `total_price` INT(100) NOT NULL ,  `placed_on` VARCHAR(50) NOT NULL ,  `pay_status` VARCHAR(100) NOT NULL DEFAULT &#039;pending&#039; ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="bookstore_db" targettable="feedback">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `bookstore_db`.`feedback` ( `id` INT(100) NOT NULL AUTO_INCREMENT ,  `user_id` INT(100) NOT NULL ,  `name` VARCHAR(100) NOT NULL ,  `email` VARCHAR(100) NOT NULL ,  `message` VARCHAR(400) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bookstore_db" targettable="orders">
                            <div class="action_content">
